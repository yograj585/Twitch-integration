...
Route::get('Shopkeeper', [App\Http\Controllers\UserManagementController::class, 'getshopkeeper'])->middleware('auth')->name('Shopkeeper');
Route::get('shopview/detail/{id}', [App\Http\Controllers\UserManagementController::class, 'shopdetails'])->middleware('auth');

Route::get('import-users', [App\Http\Controllers\SheetdbController::class, 'get']);
